(function (angular) {
    ...
    angular
        ...
        .controller("student-search.controller", ["$scope", "$filter", "submittedFileService", "submissionService", "$uibModal","Notification",
     function TeacherSearchController($scope, $filter, submittedFileService, submissionService, $uibModal, Notification) {
         ...
         function search() {
             ...
             var usId = !angular.equals($scope.ultrasoundType, {}) && !angular.isNullOrUndefined($scope.ultrasoundType) ? $scope.ultrasoundType.Id : undefined;
             submittedFileService
                 .search(usId, $scope.viewId, selectedFindings, startDate, endDate, $scope.reviewedByMe, selectedIndicationIds, $scope.pageNumber, true, false)
