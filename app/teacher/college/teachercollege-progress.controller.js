(function (angular) {
    ...
    var controller = function ($scope, $translate, $locale, submissionService) {
        ...
        $scope.loadReviewedHistory = loadReviewedHistory;
        ...
        function loadReviewedHistory() {
            submissionService
                .loadCollegeReviewed($scope.referenceDate)
                .then(function (response) {
                    if (!response) {
                        $scope.data = [];
                        return;
    ...
    angular
        ...
        .controller("teachercollege-progress.controller", controller);
