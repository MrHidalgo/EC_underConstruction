(function (angular) {
    ...
    angular
        ...
        .controller("teachercollege-search.controller", ["$scope", "$filter", "submittedFileService", "submissionService", "$uibModal", "Notification",
       ...
       //  $scope.updateOptions = updateOptions;
         ...
         function search() {
             ...
             submittedFileService
                 .searchCollegeUploads(registerTypeId, startDate, endDate, startRegisterDate, endRegisterDate, $scope.reviewedByMe, $scope.pageNumber, false, false)
